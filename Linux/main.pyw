...
"""
Linux Version of MP4 to MP3 Youtube Converter
"""
...
def downloadAudio(object):
    ...
    ydl_opts = {
       ...
       'ffmpeg_location': './FFmpeg-binaries/ffmpeg',
       'outtmpl': "./%(title)s", 
...
try:
    ...
    outputButton = ttk.Button(Rframe, text="View Output Folder", width=17, command=openOutputDirectory)
